...
class Vector{
  ...
  Vector extends ResizableContainer;
...
public:
  ...
  int vectorDimension;
  // Default constructor
  explicit Vector(){return buildedVector};
  ...
  explicit Vector(int dimension){return buildedVector};
...
#include "/home/rootking/Scrivania/exercise1/vector/vector.cpp"
